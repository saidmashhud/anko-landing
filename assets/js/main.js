...
(function ($) {
  ...
  var retinaLogos = function () {
    ...
    if (retina) {
      $("#site-logo")
        .find("img")
        .attr({ src: "assets/img/logo/logo2.png", width: "155", height: "44" });
    }
    if (retina) {
      $("#site-logo.site-logo2")
        .find("img")
        .attr({ src: "assets/img/logo/logo3.png", width: "155", height: "44" });
    }
    if (retina) {
      $("#site-logo")
        .find("img")
    ...
    if (retina) {
      $("#site-logo-2")
        .find("img")
        .attr({ src: "assets/img/logo/logo2.png", width: "298", height: "80" });
    }
    if (retina) {
      $("#site-logo3")
        .find("img")
        .attr({ src: "assets/img/logo/logo2.png", width: "158", height: "45" });
    }
    if (retina) {
      $("#site-logo4")
        .find("img")
        .attr({ src: "assets/img/logo/logo3.png", width: "158", height: "45" });
    }
  };
